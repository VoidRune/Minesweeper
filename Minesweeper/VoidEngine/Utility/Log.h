...
#define LOG_CORE_INFO(...) 	    printf("INFO CORE: " __VA_ARGS__); printf("\n")
#define LOG_CORE_WARN(...) 	    printf("WARN CORE: " __VA_ARGS__); printf("\n")
#define LOG_CORE_ERROR(...) 	printf("ERROR CORE: " __VA_ARGS__); printf("\n")
#define LOG_CORE_FATAL(...) 	printf("FATAL CORE: " __VA_ARGS__); printf("\n")
...
#define LOG_IF_CORE_INFO(x, ...) 	    if(x) {printf("INFO CORE: " __VA_ARGS__); printf("\n");}
#define LOG_IF_CORE_WARN(x, ...) 	    if(x) {printf("WARN CORE: " __VA_ARGS__); printf("\n");}
#define LOG_IF_CORE_ERROR(x, ...) 		if(x) {printf("ERROR CORE: " __VA_ARGS__); printf("\n");}
#define LOG_IF_CORE_FATAL(x, ...) 		if(x) {printf("FATAL CORE: " __VA_ARGS__); printf("\n");}
